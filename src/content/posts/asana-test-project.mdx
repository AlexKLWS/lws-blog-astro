...
Hi there! My name is Alex, I recently applied for the **Software Engineer, Tech Lead - Communications Experience** position. I had a little bit of free time, so I have decided to build a small project to showcase my skills. I'd love it if you could take a moment to check it out, along with the code. I believe my experience would be a great fit for the role, and I hope this project demonstrates that.
