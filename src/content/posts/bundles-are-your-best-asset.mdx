---
title: 'Bundles are your best asset'
subtitle: "Or why Unity's Resources system should never be used"
pubDate: 2021-10-05
metaDescription: "Why improper use of the Unity's Resources folder can bloat the size of a project’s build, lead to uncontrollable excessive memory utilization, and significantly increase application startup times"
icon: 'folder_1'
tags: ['code', 'games']
private: false
---
...
import myImage1 from "../../assets/images/bundles-are-your-best-asset/1_1.png";
import myImage2 from "../../assets/images/bundles-are-your-best-asset/2_2.png";
import myImage3 from "../../assets/images/bundles-are-your-best-asset/3_3.png";
import myImage4 from "../../assets/images/bundles-are-your-best-asset/4_4.png";
