...
And the view source code here: https://github.com/AlexKLWS/creative-fabrica-test
...
However, I wanted to challenge myself and make the project more interesting. I implemented a snap carousel component from scratch using ref forwarding. Additionally, I decided to use a technology I am not very familiar with to demonstrate my ability to quickly pick up new skills. I chose Three.js, which I had been wanting to learn better for a while now. Although I have a strong background in 3D, I haven’t had many opportunities to use Three.js during my career.
