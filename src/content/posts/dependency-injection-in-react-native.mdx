---
title: 'Dependency Injection in React Native using Typescript + Inversify + RxJS'
subtitle: 'SOLIDify your system architecture'
pubDate: 2021-07-05
metaDescription: 'Dependency Injection in React Native using Typescript + Inversify + RxJS + SOLID'
icon: 'window_1'
tags: ['code']
private: false
---
...
<iframe
  width='100%'
  height='316'
  src='https://www.youtube-nocookie.com/embed/QtDTfn8YxXg'
  frameborder='0'
